# This code will emulate the trajectories of
# several particles, that were launched under different angles. 
# Each trajectory starts at the point (0,0) 
# given initial speed in the direction 
# specified by the angle. Forward 
# Euler Method is used to accomplish this.
